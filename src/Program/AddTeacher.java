...
public class AddTeacher extends JFrame implements ActionListener {
	...
	AddTeacher(){
		...
		head=new JLabel("New Teacher Details");
		...
		String course[]= {" ","BBA","B.tech","BSC","BCOM","BCA","MCOM","MCA","MTECH"};
	...
	public void actionPerformed(ActionEvent ae) {
		...
		t.setTname(t1.getText());
		t.setTfname(t2.getText());
		t.setEmpid(l4.getText());
		
		t.setDob(((JTextField)dob.getDateEditor().getUiComponent()).getText());
		t.setTaddress(t3.getText());
		t.setTmno(t4.getText());
		
		t.setEmail(t5.getText());
		t.setTcls(t6.getText());
		t.setTcls(t7.getText());
		
		t.setAadhar(t8.getText());
		t.setQua((String)cbg.getSelectedItem());
		t.setDep((String)cbg1.getSelectedItem());
